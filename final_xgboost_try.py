...
# train.loc[train['build_year'] < 1900, 'build_year'] = np.NAN
# test.loc[test['build_year'] < 1900, 'build_year'] = np.NAN
# train['age_at_sale'] = (pd.to_datetime(train['build_year']) - pd.to_datetime(train['timestamp'])) / np.timedelta64(1, 'Y')
# test['age_at_sale'] = (pd.to_datetime(test['build_year']) - pd.to_datetime(test['timestamp'])) / np.timedelta64(1, 'Y')
id_test = test.id
